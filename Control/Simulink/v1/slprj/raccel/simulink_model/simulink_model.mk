...
MODULES              = rtGetInf.c rtGetNaN.c rt_nonfinite.c simulink_model.c simulink_model_capi.c simulink_model_data.c simulink_model_tgtconn.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = simulink_model.exe
MAKEFILE             = simulink_model.mk
MATLAB_ROOT          = C:/Program Files/MATLAB/R2023a
ALT_MATLAB_ROOT      = C:/PROGRA~1/MATLAB/R2023a
START_DIR            = C:/Users/Artis/Desktop/Ladybug/Simulink/model
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = simulink_model_ref.rsp
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/simulink_model \
